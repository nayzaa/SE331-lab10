...
import camt.cbsd.lab05.security.repository.AuthorityRespository;
...
public class DataLoader implements ApplicationRunner {
    ...
    @Autowired
    public void setAuthorityRespository(AuthorityRespository authorityRespository) {
    ...
    private void securitySetup() {
        ...
        authorityRespository.save(auth1);
        authorityRespository.save(auth2);
